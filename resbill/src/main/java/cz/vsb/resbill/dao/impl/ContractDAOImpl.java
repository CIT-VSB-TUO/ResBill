...
public class ContractDAOImpl implements ContractDAO {
  ...
  public List<Contract> findContracts(ContractCriteria criteria, Integer offset, Integer limit) {
    ...
    if (criteria != null) {
      ...
      if (criteria.getFeatures() != null) {
        ...
        if (criteria.getFeatures().contains(ContractCriteria.Feature.TARIFF)) {
          StringBuilder subJpql = new StringBuilder();
          subJpql.append(" EXISTS ( ");
          subJpql.append("   SELECT contractTariff ");
          subJpql.append("   FROM ContractTariff AS contractTariff ");
   ...
   */
  @Override
  public List<Object[]> findUninvoicedContracts(InvoiceCreateCriteria criteria, Date lastDay, List<Integer> invoiceTypeIds) {
    ...
    if (criteria.getContractId() != null) {
      jpql.append(" AND contract.id = :contractId ");
    }
