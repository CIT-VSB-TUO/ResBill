...
public class ServerServiceImpl implements ServerService {
  ...
  /**
	 * 
	 */
  public ServerDTO findServerDTO(Integer serverId) throws ResBillException {
    try {
      ...
      log.error("An unexpected error occured while finding ServerDTO by server.id=" + serverId, e);
      throw new ResBillException(e);
    }
  }
